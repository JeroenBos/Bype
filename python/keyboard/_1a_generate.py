...
_single_letters = [_get_random_str(1) for _ in range(5)]
_double_letters = [_get_random_str(2) for _ in range(5)]
_triple_letters = [_get_random_str(3) for _ in range(5)]
